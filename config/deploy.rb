...
set :application, "errbit.biodata.com"
set :repository,  "git://github.com/shukydvir/errbit.git"

role :web, "errbit.biodata.com"
role :app, "errbit.biodata.com"
role :db,  "errbit.biodata.com", :primary => true
